<template>
    ...
    <h1 class="text-3xl font-bold mx-auto text-center pt-5">Create students</h1>

    <div class="max-w-md mx-auto mt-10">
        <form action="" method="post" @submit.prevent="createStudent"  class="bg-white p-8 rounded-lg shadow-lg">
            <div class="mb-4">
...
function createStudent() {
    errors.value = {};
    axios
    .post('https://backend.test/api/students', {
        name: name.value,
        course: course.value,
        email: email.value,
        phone: phone.value
